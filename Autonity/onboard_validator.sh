...
sudo curl -o $HOME/tools/eth_extract.py https://raw.githubusercontent.com/toanbk/NodeInstaller/main/Autonity/eth_extract.py
...
echo -e "\n=============== Check Complete, Wait 1s before begin register validator .... ===================\n\n\n"

# Define the new rpc_endpoint value
new_rpc_endpoint="ws://127.0.0.1:8546"
